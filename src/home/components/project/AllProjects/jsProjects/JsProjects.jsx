    ...
    return (
        <div className="container">
            <div className="myProjects">
                <h1>1st</h1>
                <div className="card" style={{ width: "100%", background: "url(/images/rk.png)" }}>
                ...
                <h1>2nd</h1>
                <div className="card" style={{ width: "100%", background: "url(/images/SpeechRecognition.webp)", backgroundSize: "cover", backgroundPosition: "center" }}>
